...
Releases are fully automated: every merge to `main` that touches the library
runs [semantic-release](https://semantic-release.gitbook.io/) (see
`.github/workflows/release.yml`; docs-only changes are path-ignored), which
derives the version bump, changelog,
